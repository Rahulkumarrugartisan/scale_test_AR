...
function texture_tilling(model_size,scale_percentage) {
    ...
    modelViewerTexture1.addEventListener("load", async () => {
        ...
        *--|-------------------------------------------------------------------------------|*/
        ...
        try {
            ...
            const normal_texture = await modelViewerTexture1.createTexture("Material_Texture/NormalMap (3).png");
            const roughtness_texture = await modelViewerTexture1.createTexture("Material_Texture/fabrics_0078_roughness_1k.jpg");
            const oc_texture = await modelViewerTexture1.createTexture("Material_Texture/fabrics_0078_ao_1k.jpg");
