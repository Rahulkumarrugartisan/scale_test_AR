...
function dimension_calculation() {
    ...
    const y2 = size.y / 2;
    const z2 = size.z / 2;
    temp_val = cal_scale_AR_mode(size.x, temp_percentage);
    if (is_ARmode === true) {
        if (size_para_format === "ft") {
            ...
            modelViewer.querySelector('button[slot="hotspot-dim+X-Y"]').textContent =
                `${(temp_val * 3.280839895).toFixed(0)} ${size_para_format}`;
            ...
            console.log('updated size: ', temp_val* 3.280839895);
        ...
        if (size_para_format === "cm") {
            ...
            modelViewer.querySelector('button[slot="hotspot-dim+X-Y"]').textContent =
                `${(temp_val * 100).toFixed(0)} ${size_para_format}`;
            ...
            console.log('updated size: ', temp_val* 100);
        ...
        console.log('updated size in non ar: ', temp_val* 3.280839895);
        if (size_para_format === "ft") {
            modelViewer.updateHotspot({
                name: 'hotspot-dot+X-Y+Z',
                position: `${center.x + x2} ${center.y - y2} ${center.z + z2}`
