    ...
    modelViewerTexture1.addEventListener("load", async () => {
        ...
        *--|-----------------------------------------------| */
        ...
        try {
            ...
            nor_m_texture=await createTiledTexture("Defalut_Maps/silk/Silk_nor.png", 2, 2);
            mr_m_texture=await createTiledTexture("Defalut_Maps/silk/Silk_mr.png", 2, 2);
            ocm_m_texture=await createTiledTexture("Defalut_Maps/silk/Silk_oc.png", 2, 2); 
            /**|--------------------------------------------------------------------|
             *-|---Main texure maps (Base, Normal, Rougthness and Occlusion maps)---|
             *-|--------------------------------------------------------------------|*/
            get_set_MainTexture(rug_Type, material_Type, modelViewerTexture1, material, newTextureUrl,nor_m_texture, mr_m_texture, ocm_m_texture);
