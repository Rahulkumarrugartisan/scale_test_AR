...
async function loadImageAsTexture(url) {
    ...
    /**|------------------------------------------------------|
     *-|--Checking for the imge type based on file sinature---|
     *-|------------------------------------------------------|*/
...
/** This function retuns the tii=lling value */
    ...
    modelViewerTexture1.addEventListener("load", async () => {
        ...
        *--|-------------------------------------------------------------------------------|*/
        ...
        try {
            ...
            const normal_texture = await modelViewerTexture1.createTexture("Defalut_Maps/wool/wool_nor_n.png");
            const roughtness_texture = await modelViewerTexture1.createTexture("Defalut_Maps/wool/SpecularMap.png");
            const oc_texture = await modelViewerTexture1.createTexture("Defalut_Maps/wool/Wool_oc.png");
...
*--|--this is a custom function created for the use------------|
*--|-----------------------------------------------------------|*/
