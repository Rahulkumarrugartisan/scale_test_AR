...
/**|-----------------------------------------------------------------------|
 * |---This funtion handels the image aplha channel which we can set-------|
...
/**|--------------------------------------------------------------------------------------------|
 * |--this function handels the blending of the color overlay and texture or achiving the-------|
...
/**|--------------------------------------------------------------------------------|
 * |---This function handels the blending of the two textures (overlay the texture--|
...
/**|------------------------------------------------------------------------------------------------|
 * |--This function handels the tilling and ovelaying of the texture, we are using this for---------|
 ...
 * |--------------------------------------------------------------------------------|
 */
async function get_set_MainTexture(rug_type, material_type, modeviewer, material, textureURL) {

    if (rug_type === "handtufted") {
        rugType = rug_type;
        if (material_type === "tibetan_wool" || material_type === "new_zealand_wool") {
...
async function get_set_backTexture(rug_type, modelviewer, material, textureURL, shape_param) {
    if (rug_type === "handtufted") {
        ...
        if (shape_param !== "arch" && shape_param !== "capsule" && shape_param !== "drop" && shape_param !== "ogee" && shape_param !== "oval") {
    ...
    modelViewerTexture1.addEventListener("load", async () => {
        ...
        *--|-------------------------------------------------------------------------------|*/
        ...
        try {
             ...
             *-|--------------------------------------------------------------------|*/
            get_set_MainTexture(rug_Type, material_Type, modelViewerTexture1, material, newTextureUrl);

            /**|---------------------------------------------------------------------------|
             *-|------Back texture maps (Base, Normal, Roughtness and Occlusion maps)------|
             *-|---------------------------------------------------------------------------|*/
            get_set_backTexture(rug_Type, modelViewerTexture1, back_material, newTextureUrl, shape_param)
         ...
         * |---------------------------------------------------------------|*/
        scale_change(size, with_size, length_size, rugType);
