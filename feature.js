...
function trackScale(scale, delay = 500) {
    ...
    /**this is the funnction to check if the rug is getting scaled or not */
    function checkScale() {
...
setInterval(() => {
    ...
    const is_sacling = check_is_Scaling(modelViewer.cModelScale.x, 500);
  
    info_interaction.textContent = `-------isScale: ${is_sacling} -----scale: ${modelViewer.cModelScale.x}`;
    console.log('Is scaling: ', is_sacling, ' :: ', modelViewer.cModelScale.x);
