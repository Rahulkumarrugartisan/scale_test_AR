...
async function get_set_backTexture(rug_type, modelviewer, material, textureURL, shape_param) {
    if (rug_type === "handtufted") {
        ...
        if (shape_param !== "arch" && shape_param !== "capsule" && shape_param !== "drop" && shape_param !== "ogee" && shape_param !== "oval" && shape_param !== "diamond" && shape_param !== "splash" && shape_param !== "hexagon" && shape_param !== "oblong" && shape_param !== "oval" && shape_param !== "round" && shape_param !== "eight") {
